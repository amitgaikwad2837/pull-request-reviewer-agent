# v0.1 Engineering Backlog - Pull Request Reviewer Agent

## 1. Release Objective

- Product Type: GitHub Action
- Primary Command/API: ai-pr-reviewer
- v0.1 Goal: Post structured PR comments for security, performance, architecture, API, and UX checks.
...
PR diff, repository context, rule config

### Outputs

PR comments, check run summary, sarif/json artifacts
...
- Core Acceptance Test: Given PR fixture with known issues, action posts categorized review comments and marks check as failed by policy.
